          ...
          <div className="grid grid-cols-1 lg:grid-cols-7 gap-12">
            <div className="col-span-7 md:col-span-5 flex-col">
              ...
              <div className="flex flex-col flex-1 mt-8">
                ...
                <h2 className="font-bold mb-6">{post?.title}</h2>

                <div
                  className="mb-8 mt-auto prose lg:prose-base max-w-none"
                  ...
                  <ul className="flex gap-3 ">
                    {shareSocialMeida.map((item) => (
                      <Link
                        ...
                        key={item.name}
                        target="_blank"
                        className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center group transition-all duration-300 hover:bg-primary"
                      >
                        <li>
                          <FontAwesomeIcon
                            icon={item.icon}
